...
const TournamentsBlock = ({ isDesktop }: Props) => {
    ...
    const tournaments = [
        {
            name: "Тэг-регби",
            desc: `Фестиваль пройдет в двух возрастных категориях смешанных команд юношей и девушек: 7-9, 10-12 лет. 
        ...
        },
        {
            ...
            desc: `Турнир по настольному теннису среди команд школьных спортивных клубов Москвыв 2-х возрастных категориях.
        ...
        },
        {
            ...
            в дисциплинах: «Аэробика», «Аэробика 5 человек», «Степ-аэробика», «Хип-хоп», «Хип-хоп, большая группа». 
            Возрастные категории: «Аэробика» 8-10 лет, 11-13 лет, 14-16 лет; «Хип-хоп» 8-13 лет, 12-17 лет.`,
            date: "19 МАЯ",
        ...
        {
            name: "Футбол",
            desc: `Соревнования по футболу 4×4 среди команд участников проекта «Футбол в школе». Групповой этап, плей-офф.
